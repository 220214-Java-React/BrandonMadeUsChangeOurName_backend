...
import com.revanture.project1.repository.UserRepository;
...
public class UserService {
    ...
    public void create(HashMap<String, String> myUser) {
        ...
        user.setGivenName(myUser.get("givenName"));
        user.setSurname(myUser.get("surname"));
        user.setRoleId(myUser.get("roleId"));
